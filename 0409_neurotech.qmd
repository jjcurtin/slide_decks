...
We can also use those same SHAP values to understand which features contributed most strongly to any prediction for a specific person at a specific moment in time. 

This allows us to understand not only WHEN a lapse might occur but also WHY and potentially how best to intervene.
:::
...
In this project, we have embedded a prediction model that uses inputs from both EMA and geolocation within a recovery monitoring and support app. 

This app will provide participants 
