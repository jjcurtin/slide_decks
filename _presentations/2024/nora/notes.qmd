...
We've already made important strides in this direction from two parallel sensing and algothims focused grants from NIAAA and NIDA but we have just begun to scratch the surface of what we can achieve in this area with a systematic and coordinated approach.
...
Relatively large samples of individuals with either AUD and OUD have found all three sensing methods to be acceptable.  
