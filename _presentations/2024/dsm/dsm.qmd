...
metrics_ppv1 <- metrics |> 
  slice(1:5)  

metrics_ppv1[5, 2:4] <- NA
...
- Use lapse probability and locally important features to select optimal DTx modules – guided by Relapse Prevention model
- Provide recommendations with factorial manipulation of additional "transparency"
  - risk level 
  - risk change
