...
::: {.columns}
:::: {.column width="50%"}
- Compliance > 80% for 4x daily
- Compliance ~ 95% for 1x daily
::::
...
EMA compliance high over time at 4x daily and higher at 1x daily
::::
...
## Sensing Feasibility/Acceptability: Passive Signals

::: {.columns}
:::: {.column width="50%"}

OPT IN at HIGH RATES FOR GPS AND COMMUNICATIONS

::::

:::: {.column width="50%"}
OPT IN PLOTS for TWO passive
::::
:::
