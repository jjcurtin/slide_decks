...
## Modeling: Statistical Algorithms 
...
**---UPDATE FOR FOCUS ON WHAT IS auROC--**
**---UPDATE FOR FOCUS ON HELD OUT AND TRUE PREDICTION--**
- Model Tuning and Performance Evaluation
  - Area under ROC curve (AUC) as primary performance metric
  - Using [grouped]{style="color: red;"} (by participant), nested [10-fold CV]{style="color: red;"} 
