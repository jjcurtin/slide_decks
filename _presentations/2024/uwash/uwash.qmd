...
- [Large treatment disparities]{style="color: red;"} exist by race, ethnicity, geography, and income
...
- Precision mental health requires us to provide the [right treatments]{style="color: red;"} and supports to the [right people]{style="color: red;"} at the [right time]{style="color: red;"}, [every time]{style="color: red;"}
...
- Followed with sensing for up to 3 months
  - [Ecological Momentary Assessments]{style="color: red;"}
  - Contextualized Geolocation
  - Contexualized smartphone communications
...
- Collected self-report measures of acceptability
  - The [...]{style="color: gray;"} [interfered]{style="color: red;"} with my daily activities
  - I [disliked]{style="color: red;"} the [...]{style="color: gray;"}
  - I would be [willing to use]{style="color: red;"} the [...]{style="color: gray;"} [for 1 year]{style="color: red;"} to help with my recovery
...
## Sensing Feasibility/Acceptability: GPS 

::: {.columns}
:::: {.column width="50%"}

- 100% opted-in to provide [geolocation]{style="color: red;"}
...
- 150/151 opted-in to provide [communication logs and text message content]{style="color: red;"} 
- Very modest ($10/month) financial incentive
...
## Sensing Feasibility/Acceptability: Text Content 
...
- Next week = [0.90]{style="color: orange;"}; [0.88 - 0.91]
- Next day  = [0.91]{style="color: green;"}; [0.89 - 0.92]
- Next hour = [0.93]{style="color: green;"}; [0.92 - 0.94]
...
- Week model may be too coarse for JIT
::::
...
- [Week window may be too coarse for JIT]{style="color: gray;"}
