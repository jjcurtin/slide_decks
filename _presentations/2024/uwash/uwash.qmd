...
## Modeling: Area under ROC curve (auROC) 
  ...
  - [0.50 for random classifier]{style="color: red;"}
...
- [auROC = 0.50 for random classifier]{style="color: gray;"}
- [auROC = 1.00 for perfect classifer]{style="color: red;"}
...
- [auROC = 0.50 for random classifier]{style="color: gray;"}
- [auROC = 1.00 for perfect classifer]{style="color: gray;"}
- [Likelihood that model will assign a higher lapse probability to randomly selected lapse vs. no-lapse observation]{style="color: gray;"}
...
## Global Feature Importance by Model
...
## Clinical Uses: Don't Predict Lapses
...
## Clinical Uses: Do Use Probabilities

**-- auROCs, heatmap or jittered dots, calibration plots

## Clinical Uses: Who and When

**--UPDATE--**

DAY and HOUR MODEL for JIT

Push week model into future
...
## Recommending Risk Relevant Intervensions/Supports 
...
## Passive Sensing: More Risk Features 
