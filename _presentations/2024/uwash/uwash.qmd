...
:::: {.column width="50%"}
{{< embed ../../../notebooks/ema_figs_probability.qmd#roc-random >}}
::::
...
- [1.00 for perfect classifer]{style="color: red;"}
::::


:::: {.column width="50%"}
{{< embed ../../../notebooks/ema_figs_probability.qmd#roc-perfect >}}
::::
...
- [Likelihood that model will assign a higher lapse probability to randomly selected lapse vs. no-lapse observation]{style="color: red;"}
::::
...
:::: {.column width="50%"}
<!--ROC Curve for Week-->
{{< embed ../../../notebooks/ema_figs_probability.qmd#roc-week >}}
::::
...
{{< embed ../../../notebooks/ema_figs_probability.qmd#roc-week_day >}}
...
<!--ROC Curve for All-->
{{< embed ../../../notebooks/ema_figs_probability.qmd#roc-all >}}
::::
...
<!-- 
TEMP DISABLED FOR QUICK PUBLISH
...
:::: {.column width="50%"}
{{< embed ../../../notebooks/ema_figs_probability.qmd#cm_day >}}
:::
...
:::: {.column width="50%"}
- [auROC]{style="color: gray;"}

  - [Next week = 0.90; [0.88 - 0.91]]{style="color: gray;"}
  - [Next day  = 0.91; [0.89 - 0.92]]{style="color: gray;"}
  - [Next hour = 0.93; [0.92 - 0.94]]{style="color: gray;"}

- Probabilities are calibrated and ordinal
::::

:::: {.column width="50%"}
{{< embed ../../../notebooks/ema_figs_probability.qmd#calibration_plot_hour >}}
::::
...
<!-- 
TEMP DISABLE FOR QUICK PUBLISH
