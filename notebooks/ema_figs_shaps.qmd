...
Hour plot
```{r}
feature_levels <- c("valence", "future stressful event", "lapse day", "past pleasant event",
                    "future risky situation", "past risky situation", "arousal", 
                    "past stressful event", "lapse hour",
...
fig_shap_local_hour <- 
  ...
  plot_local(feature_levels, ids_day, "Hour")
```
```{r}
#| label: fig-local_day
#| fig-cap: Local SHAPS - Day
...
```{r}
jpeg(filename = here::here(path_images, "shap_local_day.jpg"))
fig_shap_local_hour
dev.off()
```