...
I'd become a clinical psychologist to help people struggling with alcohol and other substance use disorders.  
...
:::: {.row height="30%"}
![](https://github.com/jjcurtin/slide_decks/blob/main/images/gustafson.jpeg?raw=true){fig-align="right"}
::::
:::
...
- Digital therapeutics can already help with "every time" given reduced barriers to continuing care

\

- A Smart Recovery Monitoring and Support System can address "who", "when" & "what"
  - Sensing
  - AI/Machine learning
...
::: {.columns}
:::: {.column width="50%"}
- Hour model might be used for just-in-time interventions but not feasible given low PPV
::::
...
::: {.columns}
:::: {.column width="50%"}
- [Hour model might be used for just-in-time interventions but not feasible given low PPV]{style="color: gray;"}
- Day model can be used to provide daily support recommendations 
::::
...
:::: {.column width="50%"}
- [Hour model might be used for just-in-time interventions but not feasible given low PPV]{style="color: gray;"}
- [Day model can be used to provide daily support recommendations]{style="color: gray;"}] 
- Week window may be too coarse recommending daily support
...
## (Selective) Next Steps:  Implement the Recovery Monitoring and Support System

- [Use geolocation and cellular communications]{style="color: gray;"}
- [Improve algorithmic fairness]{style="color: gray;"}
- Initial Implementation of Monitoring and Support System - new grant!
