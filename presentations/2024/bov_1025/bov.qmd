---
title: 'A "Smart" Recovery Monitoring and Support System for Continuing Care'
...
![](https://github.com/jjcurtin/slide_decks/blob/main/images/ema_hand.png?raw=true){.absolute bottom=0 right=50}
...
NEED SIMPLE PLOT of Accuracy and auROCs for the three models
...
## Model Performance: Lagged Models 
...
UPDATE TO ONE PLOT PANELED BY WINDOW WIDTH WITH ONLY EMA ITEMS

ANCHOR TO SAY THAT WE SHOW THIS TO CONNECT LATER TO RECOMMENDATIONS?
...
- Empirically derived features (e.g., geolocation, language) 
...
## Next Step: Sensing Geolocation and Communcations
...
## Next Step: Monitor and Recommend in Real Time
