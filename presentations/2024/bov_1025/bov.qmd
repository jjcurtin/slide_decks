...
To start, this is a sample of individuals with a moderate to severe presentation of alcohol use disorder based on their symptom counts.  
:::
...
[auROC]{style="color: blue;"} measures the probability that model scores any true lapse higher than any true no-lapse
